...
export default function HomeScreen() {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      {/* Gradiente de transición que se desvanece a gris claro */}
      <LinearGradient
        colors={['rgba(245, 245, 245, 0)', 'rgba(245, 245, 245, 0.8)', 'rgba(245, 245, 245, 1)']}
        locations={[0, 0.5, 1]}
...
const styles = StyleSheet.create({
  ...
  fadeGradient: {
    ...
    left: 0,
    right: 0,
    height: Platform.OS === 'ios' ? 185 : 175, // Nav bar (105) + fade (80)
    zIndex: 1,
  },
  topSection: {
    padding: 24,
